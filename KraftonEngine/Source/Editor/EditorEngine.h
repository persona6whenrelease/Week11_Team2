...
public:
	...
	bool OpenAnimSequenceAsset(const FString& AssetPath) { return MainPanel.OpenAnimSequenceAsset(AssetPath); }
	...
	void ApplyTransformSettingsToGizmo(UGizmoComponent* Gizmo);
