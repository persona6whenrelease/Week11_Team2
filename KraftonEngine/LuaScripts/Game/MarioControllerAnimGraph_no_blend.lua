...
local function ConfigureStateMachine()
    ...
    return M.skelMesh:SetupStateMachineGraph({
        ...
        states = {
            {
                ...
                submachine = {
                    ...
                    transitions = {
                        ...
                        { from = "WAIT", to = "RUN", blend_duration = 0.0, conditions = {
                            { kind = "bool", name = BOOL.IS_MOVING, value = true },
                            { kind = "bool", name = BOOL.IS_RUNNING, value = true },
                        } },
                        { from = "WALK", to = "WAIT", blend_duration = 0.0, conditions = {
                            { kind = "bool", name = BOOL.IS_MOVING, value = false },
                        } },
                        { from = "WALK", to = "RUN", blend_duration = 0.0, conditions = {
                            { kind = "bool", name = BOOL.IS_RUNNING, value = true },
                        } },
                        { from = "RUN", to = "WAIT", blend_duration = 0.0, conditions = {
                            { kind = "bool", name = BOOL.IS_MOVING, value = false },
                        } },
                        { from = "RUN", to = "WALK", blend_duration = 0.0, conditions = {
                            { kind = "bool", name = BOOL.IS_MOVING, value = true },
                            { kind = "bool", name = BOOL.IS_RUNNING, value = false },
                        } },
                    }
        ...
        transitions = {
            { from = "LOCOMOTION", to = "JUMP1", blend_duration = 0.0, conditions = {
                { kind = "bool", name = BOOL.DO_JUMP1, value = true },
            } },
            { from = "LOCOMOTION", to = "JUMP2", blend_duration = 0.0, conditions = {
                { kind = "bool", name = BOOL.DO_JUMP2, value = true },
            } },
            { from = "LOCOMOTION", to = "JUMP3", blend_duration = 0.0, conditions = {
                { kind = "bool", name = BOOL.DO_JUMP3, value = true },
            } },

            { from = "JUMP1", to = "JUMP2", blend_duration = 0.0, conditions = {
                { kind = "bool", name = BOOL.DO_JUMP2, value = true },
            } },
            { from = "JUMP2", to = "JUMP3", blend_duration = 0.0, conditions = {
                { kind = "bool", name = BOOL.DO_JUMP3, value = true },
            } },

            { from = "JUMP1", to = "LOCOMOTION", blend_duration = 0.0, conditions = {
                { kind = "bool", name = BOOL.IS_GROUNDED, value = true },
            } },
            { from = "JUMP2", to = "LOCOMOTION", blend_duration = 0.0, conditions = {
                { kind = "bool", name = BOOL.IS_GROUNDED, value = true },
            } },
            { from = "JUMP3", to = "LOCOMOTION", blend_duration = 0.0, conditions = {
                { kind = "bool", name = BOOL.IS_GROUNDED, value = true },
            } },
        }
    })
