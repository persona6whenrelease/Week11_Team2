...
1.1 Improvements and New Features
    ...
    * Added transport of OpenPBR definition.
      (https://academysoftwarefoundation.github.io/OpenPBR/)

1.2 Changes and Deprecated Features

    [FBXX-1708] Updated zlib to version 1.3.1
...
2.1 Fixed Issues
    ...
    * fixed some small internal bugs.
    [FBXX-1724] Collada writer access FbxArray with the wrong method.
    [FBXX-1703] FbxGeometryConverter::Triangulate does not (re)connect the "original" geometry is connected to a node attribute instead of a node.
